"""Example: generate a KMZ mission for an L-shaped building."""
...
from flight_planner.building_presets import l_shaped_block
...
def main():
    ...
    output_path = os.path.join(OUTPUT_DIR, "l_shaped.kmz")
