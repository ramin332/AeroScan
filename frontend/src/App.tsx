...
export default function App() {
  const { result, activeTab, setActiveTab, loading, generate, refreshBuildings } = useStore();
      ...
      <main className="main">
        <div className="topbar">
          ...
          <div className="topbar-stats">
            {loading && <span className="topbar-loading">Generating...</span>}
            {!loading && s && (
              <>
